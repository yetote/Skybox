package com.example.ether.skybox.objects;
...
public class ParticlesShooter {
    ...
    public ParticlesShooter(Geometry.Point position, Geometry.Vector direction, int color,float angleVarianceInDegrees,float speedVariance) {
